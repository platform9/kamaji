...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControlPlaneAdditionalEnv) DeepCopyInto(out *ControlPlaneAdditionalEnv) {
	*out = *in
	if in.APIServer != nil {
		in, out := &in.APIServer, &out.APIServer
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlaneAdditionalEnv.
func (in *ControlPlaneAdditionalEnv) DeepCopy() *ControlPlaneAdditionalEnv {
	if in == nil {
		return nil
	}
	out := new(ControlPlaneAdditionalEnv)
	in.DeepCopyInto(out)
	return out
}
